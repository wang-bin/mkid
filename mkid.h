...
/*!
 * Example:
 * int id1 = mkid_fourcc<'H', 'E', 'V', 'C'>::value;
 * int id2 = mkid32base64_5<'H', 'e', 'l', 'l', 'o'>::value;
 * int id3 = mkid32base36_6<'M', 'r', 'W', 'a', 'n', 'g'>::value;
...
struct mkid_fourcc : public mkid32_4<128, a0, a1, a2, a3>{};
